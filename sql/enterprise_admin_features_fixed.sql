-- ============================================
-- ENTERPRISE ADMIN FEATURES - FIXED VERSION
-- Handles missing facilities table gracefully
-- Run this in Supabase SQL Editor
-- ============================================

-- ============================================
-- 0. CREATE FACILITIES TABLE IF MISSING
-- ============================================
...
CREATE TABLE IF NOT EXISTS support_tickets (
  ...
  facility_id UUID, -- Made nullable to avoid FK issues
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE support_tickets DROP CONSTRAINT IF EXISTS support_tickets_facility_id_fkey;
    ALTER TABLE support_tickets ADD CONSTRAINT support_tickets_facility_id_fkey 
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE audit_logs DROP CONSTRAINT IF EXISTS audit_logs_facility_id_fkey;
    ALTER TABLE audit_logs ADD CONSTRAINT audit_logs_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE error_logs DROP CONSTRAINT IF EXISTS error_logs_facility_id_fkey;
    ALTER TABLE error_logs ADD CONSTRAINT error_logs_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE invoices DROP CONSTRAINT IF EXISTS invoices_facility_id_fkey;
    ALTER TABLE invoices ADD CONSTRAINT invoices_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'profiles') THEN
    ALTER TABLE feature_flags DROP CONSTRAINT IF EXISTS feature_flags_created_by_fkey;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE rate_limits DROP CONSTRAINT IF EXISTS rate_limits_facility_id_fkey;
    ALTER TABLE rate_limits ADD CONSTRAINT rate_limits_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE webhooks DROP CONSTRAINT IF EXISTS webhooks_facility_id_fkey;
    ALTER TABLE webhooks ADD CONSTRAINT webhooks_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE resource_usage DROP CONSTRAINT IF EXISTS resource_usage_facility_id_fkey;
    ALTER TABLE resource_usage ADD CONSTRAINT resource_usage_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE compliance_logs DROP CONSTRAINT IF EXISTS compliance_logs_facility_id_fkey;
    ALTER TABLE compliance_logs ADD CONSTRAINT compliance_logs_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE data_exports DROP CONSTRAINT IF EXISTS data_exports_facility_id_fkey;
    ALTER TABLE data_exports ADD CONSTRAINT data_exports_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
  
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'profiles') THEN
    ALTER TABLE data_exports DROP CONSTRAINT IF EXISTS data_exports_requested_by_fkey;
    ALTER TABLE data_exports ADD CONSTRAINT data_exports_requested_by_fkey 
      FOREIGN KEY (requested_by) REFERENCES profiles(user_id);
  END IF;
END $$;
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'facilities') THEN
    ALTER TABLE api_keys DROP CONSTRAINT IF EXISTS api_keys_facility_id_fkey;
    ALTER TABLE api_keys ADD CONSTRAINT api_keys_facility_id_fkey 
      FOREIGN KEY (facility_id) REFERENCES facilities(id) ON DELETE CASCADE;
  END IF;
...
BEGIN
  ...
  RAISE NOTICE '   1. Refresh your admin panel at http://localhost:3000/admin';
  RAISE NOTICE '   2. All features should now be functional';
  RAISE NOTICE '   3. Review ENTERPRISE_FEATURES_GUIDE.md for usage';
  RAISE NOTICE '';
  RAISE NOTICE '============================================';
END $$;
