...
CREATE TRIGGER update_chat_bookmarks_updated_at BEFORE UPDATE ON chat_bookmarks FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Update chats table to support sharing metadata
